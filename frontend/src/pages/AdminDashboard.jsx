...
const AdminDashboard = () => {
  ...
  const navigationItems = [
    { label: "Overview", icon: <TbLayoutDashboardFilled />, key: "dashboard" },
    { label: "Patient Management", icon: <FaUser />, key: "patients" },
    { label: "Staff Management", icon: <HiUsers />, key: "staff" },
